    ...
    public partial class InitialTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DefinitionLineage",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TreeDefinition = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefinitionLineage", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NewsType1 = table.Column<string>(nullable: true),
                    IsDelete = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CPanelLogo = table.Column<string>(nullable: true),
                    LoginLogo = table.Column<string>(nullable: true),
                    AppLogo = table.Column<string>(nullable: true),
                    MailServerPort = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Termss = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wife", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthDateM = table.Column<DateTime>(type: "date", nullable: true),
                    BirthDateH = table.Column<DateTime>(type: "date", nullable: true),
                    ...
                    AllowAddChildren = table.Column<bool>(nullable: false),
                    AllowAddFamilyChar = table.Column<bool>(nullable: false),
                    AllowNews = table.Column<bool>(nullable: false),
                    AllowBlog = table.Column<bool>(nullable: false),
                    ...
                    Allow_GeneralNews = table.Column<bool>(nullable: false),
                    Allow_Monasabat = table.Column<bool>(nullable: false),
                    Allow_Mawaled = table.Column<bool>(nullable: false),
                    Allow_Wafeaat = table.Column<bool>(nullable: false),
                    IsLouck = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAccepted = table.Column<bool>(nullable: true),
                    IsDelete = table.Column<bool>(nullable: false),
                    CharId = table.Column<int>(nullable: true),
                    UserId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilyCharacters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FamilyCharacters_User_CharId",
                        column: x => x.CharId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyCharacters_CharId",
                table: "FamilyCharacters",
                column: "CharId",
                unique: true,
                filter: "[CharId] IS NOT NULL");
